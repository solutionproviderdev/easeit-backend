...
exports.updateFollowUp = async (req, res) => {
	...
	try {
		...
		const followUp = lead.salesFollowUp.find(
...
exports.completeMeeting = async (req, res) => {
	try {
		...
		if (
			lead.finance.soldAmmount !== undefined &&
			lead.finance.totalPayment !== undefined
		) {
			lead.finance.totalDue =
				lead.finance.soldAmmount - lead.finance.totalPayment;
		}
